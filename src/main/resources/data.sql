insert into CUSTOMERS_10 (name, surname, age, phone_number)
...
insert into ORDERS_10 (customer_id, product_name, amount)
values (4, 'milk', 95);

insert into ORDERS_10 (date, customer_id, product_name, amount)
...
insert into ORDERS_10 (product_name, amount)
values ('milk', 95);